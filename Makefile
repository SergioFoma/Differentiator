...
SOURCES = main.cpp tree.cpp treeDump.cpp parseFileDataBase.cpp mathDump.cpp mathematicalCalculator.cpp mathOperatorsInfo.cpp myStringFunction.cpp paint.cpp
