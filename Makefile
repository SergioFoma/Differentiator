...
SOURCES = main.cpp tree.cpp treeDump.cpp expertSystem.cpp myStringFunction.cpp paint.cpp parseFileDataBase.cpp mathDump.cpp mathematicalCalculator.cpp globals.cpp
